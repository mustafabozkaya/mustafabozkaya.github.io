const projects = [
  {
    ...
    shortDescription: "A responsive e-commerce app that uses React hooks and context for efficient state management, ensuring a seamless shopping experience across devices.",
    images: [
      "images/ecommercecollection.png",
      "images/ecommerce-detail1.jpg",
      "images/ecommerce-detail2.jpg"
    ],
    categories: ["web", "mobile", "react", "ecommerce","frontend"],
    longDescription: "Developed a React-based e-commerce application with advanced features such as dynamic product filtering, real-time search, and flexible sorting. The app provides a mobile-friendly design with collapsible menus, pagination, and adjustable product display, enhancing user experience on various devices.",
    technologies: ["React", "JavaScript", "HTML", "CSS", "Bootstrap", "Node.js", "Tailwind", "Express", "MongoDB"],
    features: [
      "Dynamic product filtering",
      "Real-time search and sorting",
      "Mobile-friendly design",
      "Pagination and adjustable product display",
      "State management using React hooks and context"
    ],
    keyFeatures: ["Dynamic Product Filtering", "Real-Time Search", "Mobile-Friendly Design"],   
    results: "The system achieved to easily filter the products and search for the products.",
    repoLink: "https://github.com/yourusername/react-ecommerce-app"
  },
  {
    id: 2,
    ...
    categories: ["nlp", "machinelearning", "customer_service","llms"],
  ...
  {
    id: 3,
    title: " Streamlit App for EDA",
    shortDescription: "Streamlit app for Exploratory Data Analysis.",
    images :[
      "images/streamlit_eda.jpg",
      "images/chatbot2.jpg",
      "images/chatbot3.jpg"

    ],
    categories: ["web", "mobile", "streamlit", "data_analysis","data_science"],
    longDescription: "Developed a Streamlit app for Exploratory Data Analysis, enabling users to upload data, perform analysis, and visualize results in real-time.",
    technologies: ["Python", "Streamlit", "Pandas", "Plotly", "Docker"],
    features: [
    ...
    keyFeatures: ["Data Upload", "Data Exploration", "Data Visualization"],
    results: "The system achieved to easily explore the data and gain insights.",
    repoLink: "https://ds-ml-dl-ai-solutions-projects-penguin-apppenguin-eda-c4c73z.streamlit.app"
  ...
  },
  {
    ...
    images :[
      "images/personalized-learning.jpg",
      "images/chatbot2.jpg",
      "images/chatbot3.jpg"
  ...
  },
  {
    ...
    images :[
      "images/quantum-supply-chain.jpg",
      "images/chatbot2.jpg",
      "images/chatbot3.jpg"
  ...
  },
  {
    ...
    images :[
      "images/social-media-analytics.jpg",
      "images/chatbot2.jpg",
      "images/chatbot3.jpg"

    ],
    categories: ["web", "mobile", "react", "nextjs", "machinelearning"],
  ...
  },
  {
    ...
    images :[
      "images/blockchain-supply-chain.jpg",
      "images/chatbot2.jpg",
      "images/chatbot3.jpg"
  ...
  },
  {
    ...
    images :[
      "images/ai-telemedicine.jpg",
      "images/chatbot2.jpg",
      "images/chatbot3.jpg"

    ],
    categories: ["web", "mobile", "nextjs", "machinelearning", "healthcare"],
  ...
  ,
  {
    ...
    images :[
      "images/predictive-maintenance.jpg",
      "images/chatbot2.jpg",
      "images/chatbot3.jpg"
  ...
  {
    id: 13,
    title: "Streamlit App for Titanic Survival Prediction",
    shortDescription: "Streamlit app for Titanic Survival Prediction.",
    images :[
      "images/streamlit_titanic.jpg",
      "images/chatbot2.jpg",
      "images/chatbot3.jpg"

    ],
    categories: ["web", "mobile", "streamlit", "machinelearning"],
    longDescription: "Developed a Streamlit app for Titanic Survival Prediction, enabling users to upload data, perform analysis, and visualize results in real-time.",
    technologies: ["Python", "Streamlit", "Pandas", "Plotly", "TensorFlow", "Docker"],
    features: [
      "Data upload and storage",
      "Data cleaning and preprocessing",
    ...
    keyFeatures: ["Data Upload", "Model Training", "Real-time Prediction"],
    results: "The system achieved to easily predict the Titanic survival rate.",
    
  },
  {
    id: 14,
    title: "React Native Mobile App",
    shortDescription: "A cross-platform mobile app built with React Native and essential libraries.",
    images :[
      "images/react-native-app.jpg",
      "images/chatbot2.jpg",
      "images/chatbot3.jpg"

    ],
    categories: ["mobile", "react-native", "cross-platform"],
    longDescription: "Developed a feature-rich, cross-platform mobile application using React Native. The app incorporates essential libraries for state management, navigation, and UI components, ensuring a smooth and consistent user experience across iOS and Android devices.",
    technologies: ["React Native", "Redux", "React Navigation", "Axios", "React Native Elements", "Async Storage"],
    features: [
      "Cross-platform compatibility for iOS and Android",
      "Efficient state management with Redux",
      "Smooth navigation using React Navigation",
      "RESTful API integration with Axios",
      "Consistent UI components with React Native Elements",
      "Local data persistence using Async Storage"
    ],
    keyFeatures: ["Cross-platform", "Redux State Management", "Smooth Navigation"],
    results: "Successfully launched on both App Store and Google Play",
    repoLink: "https://github.com/yourusername/react-native-mobile-app"
  },
  {
    id: 15,
    title: "iOS Weather App with SwiftUI",
    shortDescription: "A modern weather app built with SwiftUI for iOS 16 and higher.",
    images :[
      "images/weatherhome.png",
      "images/weathernight.png",
      "images/weatherlight.png",
      "images/weatherlightdev.png"

    ],
    categories: ["mobile", "ios", "swiftui"],
    longDescription: "Developed a sleek and intuitive weather application using SwiftUI for iOS 16 and higher. The app leverages the latest iOS features and design paradigms to provide users with accurate, real-time weather information and forecasts.",
    technologies: ["Swift", "SwiftUI", "Combine", "CoreLocation", "WeatherKit", "MapKit"],
    features: [
      "Real-time weather data using WeatherKit",
      "Location-based weather information with CoreLocation",
      "Interactive maps for weather visualization using MapKit",
      "Dynamic UI adapting to current weather conditions",
      "7-day forecast with detailed hourly breakdowns",
      "Weather alerts and notifications",
      "Dark mode support and dynamic typography"
    ],
    keyFeatures: ["WeatherKit Integration", "Location-based Forecasts", "Interactive Weather Maps"],
    results: "Successfully launched on the App Store with a 4.8-star rating and over 100,000 downloads in the first month.",
    repoLink: "https://github.com/yourusername/ios-weather-app-swiftui"
  },
  {
    id: 16,
    title: "iOS Developer Toolkit App",
    shortDescription: "A comprehensive mobile app showcasing Apple and iOS development tools for iOS 16+.",
    images :[
      "images/toolkithome.png",
      "images/toolkitdevelop.png",
      "images/toolkitdetail.png"

    ],
    categories: ["mobile", "ios", "swiftui", "developer-tools"],
    longDescription: "Developed an informative and interactive mobile application using SwiftUI, designed to showcase and explain various Apple and iOS development tools and frameworks. This app serves as a valuable resource for iOS developers, providing detailed information, code snippets, and practical examples for iOS 16 and higher.",
    technologies: ["Swift", "SwiftUI", "Combine", "Core Data", "CloudKit", "WidgetKit", "ARKit", "Core ML"],
    features: [
      "Comprehensive catalog of iOS development tools and frameworks",
      "Interactive demos of key SwiftUI components and layouts",
      "Code snippet library for common iOS development tasks",
      "In-app playground for testing SwiftUI code in real-time",
      "Integration with Apple's latest APIs and technologies",
      "Customizable home screen widgets using WidgetKit",
      "AR experiences demonstrating ARKit capabilities",
      "On-device machine learning examples with Core ML",
      "iCloud sync for user preferences and saved content using CloudKit",
      "Dark mode support and dynamic type accessibility"
    ],
    keyFeatures: ["SwiftUI Component Gallery", "Code Snippet Library", "Real-time SwiftUI Playground"],
    results: "Became a go-to resource for iOS developers, with over 50,000 downloads and featured on the App Store's Developer Tools category.",
    repoLink: "https://github.com/yourusername/ios-developer-toolkit-app"
  },
